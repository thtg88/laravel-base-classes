...
namespace Thtg88\LaravelBaseClasses\Validators\Concerns;

use Illuminate\Support\Facades\DB;
use Thtg88\LaravelBaseClasses\Rules\UniqueCaseInsensitive;

trait WithUniqueCaseInsensitiveValidation
{
    /**
